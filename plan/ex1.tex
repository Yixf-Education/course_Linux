...
\begin{enumerate}
  \item Linux发行版（10分钟）
    \begin{enumerate}
      ...
      \item Linux发行版的选择
        \begin{itemize}
\parpic[fr]{\includegraphics[width=8cm,height=2.8cm]{c1.linux.distribution.02.png}}
          \item 企业环境：RHEL，SUSE，……
  ...
  \item 虚拟机软件（5分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=8cm]{c1.virtualbox.01.png}}
