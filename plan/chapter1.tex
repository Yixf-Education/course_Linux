...
\begin{enumerate}
  \item 引言与导入（5分钟）
    \begin{enumerate}
      \item 三大操作系统
	\begin{itemize}
\parpic[fr]{\includegraphics[width=6cm]{c1_os_15.jpg}}
...
\item Linux发行版\textcolor{red}{（与品牌电脑/手机相类比）}
	\begin{enumerate}
	  ...
	  \item Linux发行版的选择
	    \begin{itemize}
\parpic[fr]{\includegraphics[width=9cm]{c1_linux_area_all.png}}
	      \item 企业环境：RHEL，SUSE，……
...
\otherHeader
  ...
  \item 操作系统组件（15分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=5.5cm]{c1_system_parts_01.png}}
  ...
  \item Linux的学习（15分钟）
    \begin{enumerate}
      ...
      \item Linux的学习
	\begin{itemize}
\parpic[fr]{\includegraphics[width=7cm]{c1_man_page_02.png}}
	  \item GUI vs. CLI
	  \item 策略：学习 + 摸索 + 实践 + 总结
  ...
  \item
    ...
    \end{enumerate}
      ...
      %\begin{figure}[h]
        %\centering
        %\includegraphics[width=7cm]{c1_man_page_02.png}
        %\includegraphics[width=9cm]{c1_man_page_01.png}
      %\end{figure}

  \item 总结与答疑（5分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=11.3cm]{c1_man_page_01.png}}
      \item 知识点
	\begin{itemize}
	  \item Linux的历史与现状
	  \item Linux的两层含义
