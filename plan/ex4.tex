...
\begin{enumerate}
  \item 命令的帮助（10分钟）
    \begin{enumerate}
\parpic[fr]{\includegraphics[width=8.5cm,height=2.3cm]{c4_command.png}}
    ...
    \end{enumerate}
  \item 命令的语法（5分钟）
\parpic[fr]{\includegraphics[width=8.5cm,height=2.5cm]{c4_command_ls.png}}
    \begin{enumerate}
	...
	\end{itemize}
      \item 补充说明
	\begin{itemize}
\parpic[fr]{\includegraphics[width=8.5cm,height=6.2cm]{c4_metacharacter.png}}
  ...
  \item 命令的修改（5分钟）
	...
	\begin{figure}[h]
	  \centering
	  \includegraphics[width=7.5cm]{c4_io_01.jpg}
	  \quad
	  \includegraphics[width=9.3cm]{c4_io.png}
	\end{figure}
	\vspace*{-10pt}
      \item 管道
\parpic[fr]{\includegraphics[width=8cm]{c4_pipe.png}}
