...
\begin{enumerate}
  \item
    ...
    \begin{enumerate}
      \item 软件包管理系统
	\begin{itemize}
\parpic[fr]{\includegraphics[width=8cm]{c6_software.png}}
...
\otherHeader
	  ...
	  \item \textcolor{red}{\textbf{【重点】}}APT\textcolor{red}{（实例讲解、操作演示）}
	    \begin{itemize}
\parpic[fr]{\includegraphics[width=8.3cm,height=7cm]{c6_apt_01.png}}
	...
	\begin{enumerate}
	  \item 简介
	    \begin{itemize}
%\parpic[fr]{\includegraphics[width=8.8cm,height=7.5cm]{c6_rpm_01.png}}
	      \item RPM：rpm软件包管理器
	      \item Yum：RPM的前端
	    \end{itemize}
...
\otherHeader
      ...
      \item 开源许可证
	\begin{itemize}
\parpic[fr]{\includegraphics[width=8.5cm]{c6_license_choose_01.png}}
