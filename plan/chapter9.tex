...
\vspace*{-10pt}
\begin{figure}[h]
\parpic[fr]{\includegraphics[width=8.5cm]{c9_perl_array_02.jpg}}
\end{figure}
\vspace*{-10pt}
\vspace*{-3pt}
\begin{verbatim}
...
\parpic[fr]{\includegraphics[width=3.8cm]{c9_perl_hash_01.png}}
\begin{verbatim}
# 创建散列
%person = (
name => 'Paul',
...
\otherHeader
  ...
  \item \textcolor{red}{\textbf{【难点】}}判断语句（20分钟）\textcolor{red}{（结合逻辑流程讲解语法结构，并进行实例分析）}
    \begin{enumerate}
      \item if
\parpic[fr]{\includegraphics[width=6.5cm]{c9_perl_elsif_01.png}}
\vspace*{-3pt}
\begin{verbatim}
# if区块
if ($hour > 22) {
...
\vspace*{-15pt}
\begin{figure}[h]
\parpic[fr]{\includegraphics[width=5.8cm]{c9_perl_foreach_01.jpg}}
\end{figure}
\vspace*{-13pt}
\begin{verbatim}
@group = 1..10;
...
\vspace*{-15pt}
\begin{figure}[h]
\parpic[fr]{\includegraphics[width=6.5cm]{c9_perl_for_01.png}}
\end{figure}
\vspace*{-13pt}
\begin{verbatim}
# 从1数到10
