...
\begin{enumerate}
  ...
  \item
	...
	\vspace*{-10pt}
      \item 变量使用
	\begin{itemize}
\parpic[fr]{\includegraphics[width=9cm,height=4.5cm]{c8.shell.buildin.01.png}}
...
\otherHeader
	...
	\begin{itemize}
	  \item if-then
	    \begin{itemize}
	      \item if-then
\parpic[fr]{\includegraphics[width=8cm,height=2cm]{c8.if.01.jpg}}
\begin{verbatim}
if some_condition
then
  something happens
...
\end{verbatim}
	      \item if-then-else
\parpic[fr]{\includegraphics[width=8cm]{c8.if.02.jpg}}
\begin{verbatim}
if some_condition
then
  something happens
...
\parpic[fr]{\includegraphics[width=8cm]{c8.if.03.jpg}}
\begin{verbatim}
if some_condition
then
  something happens
...
\otherHeader
		...
		\item 逻辑运算符or（||）
\parpic[fr]{\includegraphics[width=9cm]{c8.for.01.png}}
\begin{verbatim}
if [ cond1 || cond2 ]
then
  some action
...
\end{verbatim}
	  ...
	  \item case
\parpic[fr]{\includegraphics[width=11cm]{c8.case.01.png}}
\begin{verbatim}
case expression in
  pattern1)
    action1
...
\end{verbatim}
	...
	\end{itemize}
      ...
      \item 迭代流程控制
\parpic[fr]{\includegraphics[width=8.5cm]{c8.while.01.png}}
	\begin{itemize}
	  \item while
\begin{verbatim}
while condition
...
\end{verbatim}
	  ...
	  \item until
\parpic[fr]{\includegraphics[width=8.5cm]{c8.until.01.png}}
\begin{verbatim}
until condition
do
  action
...
for VAR in LIST
\end{verbatim}
\parpic[fr]{\includegraphics[width=10cm]{c8.std.01.jpg}}
\begin{verbatim}
do
  action
done
