...
\begin{enumerate}
  \item 引言与导入（5分钟）
	...
	\begin{itemize}
\parpic[fr]{\includegraphics[width=9cm]{c3_filesystem_11.png}}
  ...
  \item 文件系统基础（20分钟）
	...
	\end{itemize}
      \item Linux的目录结构
        \begin{itemize}
\parpic[fr]{\includegraphics[width=11cm]{c3_filesystem_01.jpg}}
  ...
  \item 文件系统导航（25分钟）
	...
	\begin{itemize}
\parpic[fr]{\includegraphics[width=9cm]{c3_ls.png}}
...
\otherHeader
  ...
  \item 文件类型（20分钟）
    \begin{enumerate}
	  ...
	  \end{itemize}
        ...
        \begin{figure}[h]
	  \centering
	  \includegraphics[width=4.8cm]{c3_ln1.png}
	  \includegraphics[width=5.2cm]{c3_ln2.png}
	  \includegraphics[width=5.6cm]{c3_ln3.png}
	\end{figure}
        \vspace*{-15pt}
  ...
  \item 文件和目录权限（20分钟）
	...
	\begin{figure}[h]
	  \centering
%\parpic[fr]{\includegraphics[width=5cm]{c3_ugo_01.png}}
          \includegraphics[width=7cm]{c3_ugo_01.png}
	  \quad
          \includegraphics[width=8cm]{c3_rwx.png}
	\end{figure}
	\vspace*{-10pt}
