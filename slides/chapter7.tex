...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=5.9cm,height=6.45cm]{c7.txt.png}
    \vspace*{0.1cm}
    \includegraphics[width=6cm]{c7.word.png}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{引言 | 文本编辑器}
  \begin{center}
    \includegraphics[width=10cm]{c7.editors.01.png}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{引言 | 文本编辑器}
  \begin{center}
    \includegraphics[width=11cm]{c7.editors.02.png}
  \end{center}
\end{frame}
...
\begin{frame}
  \frametitle{引言 | 文本编辑器}
  \begin{center}
    \includegraphics[width=11cm]{c7.editor.linux.01.jpg}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{center}
    \includegraphics[width=11cm,height=9cm]{c7.learn.code.jpg}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5.8cm]{c7.vim.start.01.png}\quad
    \includegraphics[width=5.8cm]{c7.vim.start.02.png}\\
    \includegraphics[width=12cm]{c7.vim.start.03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.statusline.04.png}
    \vspace{0.2cm}
    \includegraphics[width=12cm]{c7.vim.statusline.01.png}
    \vspace{0.2cm}
    \includegraphics[width=12cm]{c7.vim.statusline.02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.mode.01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c7.vim.mode.07.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{c7.vim.hjkl.01.jpg}
  \end{figure}
  \begin{table}
    \centering
    \rowcolors[]{1}{blue!20}{blue!10}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{c7.vim.hjkl.02.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm,height=8cm]{c7.vim.plugin.01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c7.vim.command.01.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c7.vim.command.02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.shortcut.01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm,height=8cm]{c7.vim.shortcut.02.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm,height=8cm]{c7.vim.shortcut.03.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.shortcut.04.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.shortcut.05.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.shortcut.06.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c7.vim.keyboard.png}
  \end{figure}
\end{frame}
