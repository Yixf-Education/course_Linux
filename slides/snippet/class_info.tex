...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=0.38\textwidth]{c0.linux.railway.01.jpg}\quad
    \includegraphics[width=0.45\textwidth]{c0.linux.10.04.jpg}
  \end{figure}
  \pause
  \begin{block}{如果你是}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<1->{\includegraphics[width=5cm]{c0.windows.view.02.jpg}}
    \quad
    \visible<2->{\includegraphics[width=5.4cm]{c0.linux.view.02.png}}
  \end{figure}
\end{frame}
