...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{c4.command.png}
  \end{figure}
  \pause
  \begin{block}{Linux命令}
    %\begin{itemize}[<+-|alert@+>]
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7cm]{c4.command.ls.png}
  \end{figure}
  \pause
  %\begin{itemize}[<+-|alert@+>]
  \begin{itemize}[<+->]
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6cm]{c4.help.source.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{c4.man.apropos.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{c4.info.ls.png}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c4.ls.help.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c4.apropos.who.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c4.metacharacter.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=8cm]{c4.metacharacter.example.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c4.shell.01.png}
  \end{figure}
  \pause
  \begin{block}{比较输出结果}
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c4.io.01.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c4.pipe.png}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c4.echo.png}
  \end{figure}
  \pause
  \begin{block}{\alert{-e}}
    \begin{itemize}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c4.cat.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c4.top.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm,height=5.3cm]{c4.top.key.png}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm]{c4.ps.aux.png}\\
    \includegraphics[width=11cm]{c4.ps.axo.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \textbf{pstree} displays the processes running on the system in the form of a \textbf{tree diagram} showing the relationship between a process and its parent process and any other processes that it created. Repeated entries of a process are not displayed, and threads are displayed in curly braces.
    \column{0.6\textwidth}
    \includegraphics[width=\textwidth]{c4.pstree.jpg}
  \end{columns}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=11cm,height=7.5cm]{c4.jobs.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c4.at.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=10cm]{c4.cron.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
  \centering
    \includegraphics[width=11cm]{c4.andor.01.jpg}
    \vspace{0.3cm}
    \includegraphics[width=11cm]{c4.andor.02.png}
  \end{figure}
\end{frame}
