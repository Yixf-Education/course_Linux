...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<2>{ \includegraphics[width=6cm]{c3.partition.10.jpg} }
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  %\begin{figure}
    %\centering
    %\vspace{-0.2cm}
    %\visible<6>{ \includegraphics[width=9.5cm]{c3.filesystem.11.png} }
    %\includegraphics[width=9.5cm]{c3.filesystem.11.png}
  %\end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=12cm]{c3.filesystem.03.png}
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{c3.etc.var.jpg}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \visible<5>{ \includegraphics[width=10cm]{c3.ls.png} }
  \end{figure}
\end{frame}
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \visible<5>{ \includegraphics[width=10cm]{c3.inode.12.png} }
  \end{figure}
\end{frame}
