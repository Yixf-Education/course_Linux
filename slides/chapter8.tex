...
\begin{frame}
  ...
  \begin{block}{\href{https://archive.tinychan.org/read/prog/1295544154}{Genius sorting algorithm: Sleep sort}}
    \begin{figure}
      \centering
      \includegraphics[width=0.7\textwidth]{c8_sleep_sort.png}
    \end{figure}
  \end{block}
\end{frame}
