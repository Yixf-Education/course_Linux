...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=7cm]{c8_star_heart_30.png}
  \end{figure}
\end{frame}
...
%echo The number of arguments passed from the command line is: $#
\begin{lstlisting}
#!/bin/bash
...
\subsection{GAOXIAO的睡眠排序}
\begin{frame}[fragile]
  \frametitle{shell函数 | 睡眠排序 | 原版}
\begin{lstlisting}
#!/bin/bash
...
\begin{frame}
  \frametitle{shell函数 | 睡眠排序 | 参考资料}
  \begin{block}{Sleep sort}
    \begin{itemize}
      \item \href{https://archive.tinychan.org/read/prog/1295544154}{Genius sorting algorithm: Sleep sort}
      \item \href{https://rosettacode.org/wiki/Sorting_algorithms/Sleep_sort}{Sorting algorithms/Sleep sort}
    \end{itemize}
    \vspace{-1em}
    \begin{figure}
      \centering
      \includegraphics[width=0.55\textwidth]{c8_sleep_sort.png}
    \end{figure}
  \end{block}
\end{frame}
...
\begin{frame}
  \frametitle{Linux | 参考资料}
  \begin{block}{总结与学习资料}
    \begin{itemize}
      \item \href{https://github.com/jlevy/the-art-of-command-line/blob/master/README-zh.md}{the-art-of-command-line@GitHub}
      \item \href{https://explainshell.com/}{explainshell.com}
    \end{itemize}
  \end{block}
\end{frame}
