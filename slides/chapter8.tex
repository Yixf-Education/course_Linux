...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=9cm]{c8_shell_buildin_01.png}\\
...
\begin{frame}
  ...
  \begin{figure}
    \centering
    \includegraphics[width=6cm]{c8_conditional_01.jpg}
    \includegraphics[width=6cm]{c8_iterative.jpg}
  \end{figure}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \begin{figure}
    \centering
    \includegraphics[width=5cm]{c8_expr_02.png}
    \includegraphics[width=7cm]{c8_expr_01.png}
    \vspace{0.3cm}
