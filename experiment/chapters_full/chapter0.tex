...
\begin{figure}[h]
  \centering
  \includegraphics[width=\textwidth]{markdown.cheatsheet.01.png}
  \includegraphics[width=\textwidth]{markdown.cheatsheet.02.png}
\end{figure}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.8\textwidth]{markdown.example.01.png}
  \includegraphics[width=\textwidth]{markdown.example.02.jpg}
\end{figure}
